...
class TestMainFunction:
    ...
    @patch("app.config.url_tenders", "http://test.com/tenders")
    @patch("app.config.url_by_code")
    def test_main_individual_tender_error(
        self, mock_url_by_code, mock_send, mock_make_request
    ):
        ...
        tenders_response = {
            "Listado": [{"CodigoExterno": "123"}, {"CodigoExterno": "456"}]
        }
...
class TestIntegration:
    ...
    def test_full_workflow_success(self, mock_get, mock_redis):
        ...
        tenders_response.json.return_value = {"Listado": [{"CodigoExterno": "123"}]}
